...
const AuthPage: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <Box component='form' sx={{ width: '100%', marginTop: 1 }} onSubmit={submitHandler}>
            ...
            <Grid container justifyContent='center'>
              <Grid size='grow'>
                <Link onClick={() => navigate('/reset')} variant='body2' sx={{ cursor: 'pointer' }}>
                  Forgot password?
                </Link>
              </Grid>
              <Grid>
                <Link sx={{ cursor: 'pointer' }} onClick={switchModeHandler} variant='body2'>
      ...
      <Box
        component='footer'
        sx={{ padding: (theme) => theme.spacing(UI_SPACING_DEFAULT, 2), marginTop: 'auto' }}
      >
